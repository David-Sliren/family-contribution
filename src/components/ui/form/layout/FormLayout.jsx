...
export const FormLayout = ({
  ...
  return (
    <div
      className={`w-full md:w-fit bg-surface-container-lowest rounded-[2rem] p-8 md:p-12 tonal-shadow-sm ring-1 ring-outline-variant/15 animate-fade-in-up ${className}`}
    >
